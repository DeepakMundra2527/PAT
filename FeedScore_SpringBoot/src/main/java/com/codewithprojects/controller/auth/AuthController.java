...
//	private final String TOKEN_PREFIX="Bearer";
	...
	@PostMapping("/verify")
	public ResponseEntity<Boolean> verifyUser(@RequestBody VerificationDto verificationDto) {
	    boolean isVerified = authService.verify(verificationDto);
	    return ResponseEntity.ok(Boolean.valueOf(isVerified));
	}
